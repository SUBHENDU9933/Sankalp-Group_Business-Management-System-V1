...
export default function EstimatesPage() {
  ...
  const openEditor = (estimateId) => { window.location.href = buildEstimatorUrl({ estimateId }); };
  const openNew = () => { window.location.href = buildEstimatorUrl({}); };
  ...
  return (
    <div data-testid="estimates-page">
      <PageHeader subtitle="Phase 7" title="Estimate Management" actions={can("estimates", "create") ? <Button onClick={openNew} className="rounded-none bg-orange-500 hover:bg-orange-600 text-white" data-testid="estimate-new-button"><Plus className="w-4 h-4" /> New Estimate</Button> : null} />
      <PageBody>
